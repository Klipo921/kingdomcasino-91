...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-b0f0c40e');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-b0f0c40e');}
...
function clearFlash(){dieView.classList.remove('rl-win-b0f0c40e');dieView.classList.remove('rl-lose-b0f0c40e');if(frameEl){frameEl.classList.remove('rl-win-b0f0c40e');frameEl.classList.remove('rl-lose-b0f0c40e');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-b0f0c40e');if(frameEl){frameEl.classList.add('rl-win-b0f0c40e');}}else{dieView.classList.add('rl-lose-b0f0c40e');if(frameEl){frameEl.classList.add('rl-lose-b0f0c40e');}}
...
var brandEl=document.querySelector('.rl-brand-b0f0c40e');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
